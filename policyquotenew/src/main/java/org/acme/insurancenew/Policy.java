...
public class Policy implements java.io.Serializable
{
   ...
   private org.acme.insurancenew.Driver driver;
   ...
   public org.acme.insurancenew.Driver getDriver()
   {
      return this.driver;
   }

   public void setDriver(org.acme.insurancenew.Driver driver)
   {
      this.driver = driver;
   }
   ...
   public Policy(java.util.Date requestDate, java.lang.String policyType,
         ...
         java.lang.Integer priceDiscount, org.acme.insurancenew.Driver driver)
   {
      this.requestDate = requestDate;
      this.policyType = policyType;
      this.vehicleYear = vehicleYear;
